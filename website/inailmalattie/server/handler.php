<?php
	...
	function filterData(){
		...
		$query_string = "SELECT singolesedi.latitudineProvincia, singolesedi.longitudineProvincia, count(*) AS count 
		...
		GROUP BY singolesedi.latitudineProvincia, singolesedi.longitudineProvincia'";
